...
/**
 * The novinpayamak message processor
 *
 * @package   message_novinpayamak
 * @copyright 2008 Luis Rodrigues
...
class message_output_novinpayamak extends message_output {
  ...
  function send_message($eventdata) {
    ...
    try {
		...
		$res = $client->Send(
			array(
				'Auth' 	=> array('number' => $parameters['fromNumber'],'pass' => $parameters['password']),
				'Recipients' => $parameters['toNumbers'],
				'Message' => array($parameters['messageContent']),
				'Flash' => $flash
				)
			);
...
/*
 *
 *         $f = fopen('/tmp/event_novinpayamakx', 'a+');
...
$a = new message_output_novinpayamak();
